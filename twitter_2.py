...
<head>
	...
	<script type="text/javascript" language="javascript">
        function checkform(x)
        {
            ...
            var cansubmit = true;
            if(account_address.value == "" || num_tweets.value == "") cansubmit = false;
            if(x) cansubmit = true;
...
<body>
    <div id="main_wrapper">
        ...
        <section id="t_section">
            ...
            <br>
            <h2>A specific user's tweets extractor</h2>
            <br>
            <form action="twitter_2_result.py" method="post" autocomplete="on">
                <fieldset>
                    <legend>Inputs:</legend>
                    <br>
                    <h2>Account's address</h2>
                    <label for="account_address">Enter the account's address (@):</label>
                    ...
                    <label for="num_tweets">Maximum number of tweets to extract:</label>
