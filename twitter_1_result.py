...
funct_choice_1(keywords_list, int(num_tweets))
...
<body>
	<div id="main_wrapper">
		...
		<section id="w_section">
			...
			<br>
			<h1>Recent Popular tweets extractor</h1>
			<br>
			...
			<br>
			<p><a href="Results/export_dataframe.csv" download="export_dataframe.csv"><img src="src/csv.png" alt="Twitter Scraper"/></a></p>
			<br>
		</section>
	</div>
</body>
