#coding:utf-8
import cgi
from worldometers_corona_scraper import *
...
<body>
	<div id="main_wrapper">
		<header id="top_header">
			<h1>Worldometers COVID-19 Data Extractor</h1>
		</header>
		<section id="w_section">
			...
			<br>
			<p><a href="Results/corona_country.csv" download="corona_country.csv"><img src="src/csv.png" alt="Worldometers Scraper"/></a></p>
			<br>
		</section>
	</div>
</body>
